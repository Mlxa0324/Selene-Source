...
import uk.oxiang.ivy.tv.core.common.network.model.TvHomeResponse
import uk.oxiang.ivy.tv.core.common.network.model.TvPlayRecordResponse
import uk.oxiang.ivy.tv.core.common.network.model.TvSearchResourceResponse
...
/**
 * core-common 测试用 TV 数据接口，供各 Repository 单测按需覆写单个方法。
 */
