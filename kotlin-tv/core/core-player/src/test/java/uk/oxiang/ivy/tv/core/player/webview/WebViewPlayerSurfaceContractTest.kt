...
class WebViewPlayerSurfaceContractTest {
    ...
    private fun readSurfaceSource(): String {
        return File("src/main/java/uk/oxiang/ivy/tv/core/player/webview/WebViewPlayerSurface.kt")
            .readText()
    }
    ...
    private fun readCommandSource(): String {
        return File("src/main/java/uk/oxiang/ivy/tv/core/player/webview/WebViewPlayerCommand.kt")
            .readText()
    }
