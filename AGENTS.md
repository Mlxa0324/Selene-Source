...
### 2026-05-17 00:00:00
- 应用设置新增“主题色”切换，提供 `经典影院绿 / 深海蓝 / 霓虹紫 / 落日橙 / 玫瑰红` 五套固定全局主题色方案，默认保持经典影院绿。
- 新的主题色选择会本地持久化保存，下次启动继续沿用，不影响原有明暗主题逻辑。
- 首页、分类页、源浏览器、筛选标签与通用下拉刷新等高频品牌强调色改为跟随全局主题色联动，切换后可立即看到明显变化。
